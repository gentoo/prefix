...
# $Header: /var/cvsroot/gentoo-x86/dev-util/pmk/pmk-0.10.1.ebuild,v 1.2 2007/07/12 01:05:42 mr_bones_ Exp $
...
src_install () {
	make DESTDIR="${D}" MANDIR="${EPREFIX}"/usr/share/man install || die
