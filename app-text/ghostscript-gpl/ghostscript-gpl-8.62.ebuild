...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/app-text/ghostscript-gpl/ghostscript-gpl-8.62.ebuild,v 1.1 2008/03/04 21:02:22 tgurr Exp $
...
src_unpack() {
	...
	# remove internal copies of expat, jasper, jpeg and libpng
	rm -rf "${S}/expat"
	rm -rf "${S}/jasper"
	rm -rf "${S}/jpeg"
	rm -rf "${S}/libpng"
