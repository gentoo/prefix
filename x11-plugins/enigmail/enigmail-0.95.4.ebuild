...
# $Header: /var/cvsroot/gentoo-x86/x11-plugins/enigmail/enigmail-0.95.4.ebuild,v 1.1 2007/10/23 17:39:53 armin76 Exp $
...
src_install() {
	...
	sed -i -e "s/2\.0a1/2.0.0.*/" ${ED}${MOZILLA_FIVE_HOME}/extensions/${emid}/install.rdf
