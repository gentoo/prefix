...
src_unpack() {
	...
	# remove warnings
	epatch "${FILESDIR}"/mutt-1.5.15-anti-warnings.patch
	# back out pkgsrc patch that breaks for us with berkely db
	epatch "${FILESDIR}"/mutt-1.5.15-bdb-configure.patch
