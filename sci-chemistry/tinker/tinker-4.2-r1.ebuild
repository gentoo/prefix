...
pkg_postinst() {
	einfo "Tinker binaries installed to ${EROOT}usr/bin."
	einfo "Parameter files installed to ${EROOT}usr/share/tinker/params."
	...
	einfo "You must edit ${EROOT}usr/bin/tinker if you aren't using Blackdown."
}
