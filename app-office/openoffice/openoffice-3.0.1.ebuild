...
# $Header: /var/cvsroot/gentoo-x86/app-office/openoffice/openoffice-3.0.1.ebuild,v 1.2 2009/01/29 08:06:13 suka Exp $
...
src_unpack() {
	...
	# Prefix patch
	epatch "${FILESDIR}/ooo-build-3.0.0.3.6-prefix.patch"
