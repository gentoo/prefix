...
IUSE="aqua 3dnow 3dnowext +a52 aalib +alsa altivec +ass bidi bindist bl bs2b
...
LICENSE="GPL-2"
if [[ ${PV} != *9999* ]]; then
	KEYWORDS="~amd64-linux ~x86-linux ~ppc-macos ~x86-macos ~sparc-solaris ~x86-solaris ~x64-macos"
else
	KEYWORDS=""
fi
