...
# $Header: /var/cvsroot/gentoo-x86/dev-java/jython/jython-2.2.1-r1.ebuild,v 1.6 2009/01/01 11:20:28 ali_bush Exp $
...
src_install() {
	...
	local java_args="-Dpython.home=${EPREFIX}/usr/share/jython"
	java_args="${java_args} -Dpython.cachedir=\${HOME}/.jythoncachedir"

	java-pkg_dolauncher jythonc \
						--main "org.python.util.jython" \
						--java_args "${java_args}" \
						--pkg_args "${java_args} ${EPREFIX}/usr/share/jython/tools/jythonc/jythonc.py"
