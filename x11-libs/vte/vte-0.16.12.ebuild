...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/vte/vte-0.16.12.ebuild,v 1.8 2008/04/13 22:06:16 vapier Exp $

EAPI="prefix"

inherit eutils gnome2 autotools python flag-o-matic
...
src_unpack() {
	...
	# this is not supported by interix ld!
