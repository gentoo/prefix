...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-gui/qt-gui-4.5.0_rc1.ebuild,v 1.3 2009/02/13 23:05:35 hwoarang Exp $
...
src_install() {
	...
	rm -f "${ED}${QTHEADERDIR}"/{Qt,QtGui}/{qmacstyle_mac.h,qwindowdefs_win.h} \
		"${ED}${QTHEADERDIR}"/QtGui/QMacStyle
