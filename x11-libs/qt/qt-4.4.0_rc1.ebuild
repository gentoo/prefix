...
IUSE="accessibility cups dbus debug doc examples firebird glib jpeg mng mysql nas nis odbc opengl pch postgres qt3support sqlite sqlite3 ssl tiff xinerama ${IUSE_INPUT_DEVICES} aqua"
