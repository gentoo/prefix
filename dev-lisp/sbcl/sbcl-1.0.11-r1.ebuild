...
# $Header: /var/cvsroot/gentoo-x86/dev-lisp/sbcl/sbcl-1.0.11-r1.ebuild,v 1.3 2007/12/19 02:54:06 halcy0n Exp $
...
EOF
	...
	echo "SBCL_HOME=${EPREFIX}/usr/$(get_libdir)/sbcl" > "${T}/50sbcl"
	echo "SBCL_SOURCE_ROOT=${EPREFIX}/usr/$(get_libdir)/${PN}/src" >> "${T}/50sbcl"
	doenvd "${T}/50sbcl"
