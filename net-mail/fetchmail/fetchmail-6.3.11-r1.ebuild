...
# $Header: /var/cvsroot/gentoo-x86/net-mail/fetchmail/fetchmail-6.3.11-r1.ebuild,v 1.4 2009/08/29 18:46:14 armin76 Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PV}-fix-free-corruption.patch
