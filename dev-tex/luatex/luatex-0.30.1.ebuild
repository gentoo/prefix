...
# $Header: /var/cvsroot/gentoo-x86/dev-tex/luatex/luatex-0.30.1.ebuild,v 1.1 2008/10/13 12:14:51 aballier Exp $
...
SRC_URI="http://foundry.supelec.fr/frs/download.php/683/${PN}-beta-${PV}.tar.bz2
