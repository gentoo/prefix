...
# $Header: /var/cvsroot/gentoo-x86/sys-apps/util-linux/util-linux-2.16.2.ebuild,v 1.11 2010/03/01 17:24:26 ssuominen Exp $
...
if [[ ${PV} == "9999" ]] ; then
	...
	SRC_URI="mirror://kernel/linux/utils/util-linux-ng/v${PV:0:4}/${MY_P}.tar.bz2
		loop-aes? ( mirror://gentoo/${PN}-2.16.1-loop-aes.patch.bz2 )"
