...
# $Header: /var/cvsroot/gentoo-x86/dev-libs/libxml2/libxml2-2.7.2-r1.ebuild,v 1.9 2008/12/07 12:03:34 vapier Exp $
...
LICENSE="MIT"
SLOT="2"
KEYWORDS="~amd64-linux ~ia64-hpux ~m68k-mint ~ppc-aix ~ppc-macos ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-freebsd ~x86-interix ~x86-linux ~x86-macos ~x86-solaris ~x86-winnt"
