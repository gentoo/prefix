...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~ppc-aix ~x64-freebsd ~x86-freebsd ~hppa-hpux ~ia64-hpux ~x86-interix ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
IUSE="doc"
...
src_unpack() {
	...
	case ${CHOST} in
		...
		*-solaris2.8|*-solaris2.9)
			# Don't remove dirfd!
			requested_gnulib_modules="alphasort dirfd getopt scandir setenv strcasestr stdint strndup strsep xvasprintf"
			;;
		*-solaris2.10)
			requested_gnulib_modules="dirfd getopt strcasestr strndup strsep xvasprintf"
			;;
		*-solaris2.11)
