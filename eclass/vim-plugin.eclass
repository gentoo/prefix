...
vim-plugin_src_install() {
	...
	find ${S} -group 'portage' -exec chgrp 0 '{}' \; || die "chgrp failed"
	eend $?
...
vim-plugin_pkg_postrm() {
	...
	find ${PREFIX}/usr/share/vim/vimfiles -depth -type d -exec rmdir {} \; 2>/dev/null
}
...
update_vim_afterscripts() {
	local d f afterdir=${PREFIX}/usr/share/vim/vimfiles/after
