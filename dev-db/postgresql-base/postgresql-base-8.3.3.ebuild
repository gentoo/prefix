...
# $Header: /var/www/viewcvs.gentoo.org/raw_cvs/gentoo-x86/dev-db/postgresql-base/postgresql-base-8.3.3.ebuild,v 1.2 2008/06/14 10:42:50 dev-zero Exp $
...
src_compile() {
	econf --prefix="${EPREFIX}"/usr/$(get_libdir)/postgresql-${SLOT} \
		...
		--with-locale-dir="${EPREFIX}"/usr/share/postgresql-${SLOT}/locale \
