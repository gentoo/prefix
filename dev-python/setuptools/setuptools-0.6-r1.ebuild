...
# $Header: /var/cvsroot/gentoo-x86/dev-python/setuptools/setuptools-0.6-r1.ebuild,v 1.1 2009/08/11 22:06:47 arfrever Exp $
...
#	sed -e 's/name="distribute"/name="setuptools"/' -i setup.py || die "sed setup.py failed"
#	sed -e '/name="distribute"/a \
#    provides=["setuptools (0.6)"],' -i setup.py
