...
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~ppc-aix ~x86-freebsd ~ia64-hpux ~x86-interix ~amd64-linux ~ia64-linux ~x86-linux ~x86-linux ~ppc-macos ~x86-macos ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
IUSE="extwrapper"
...
localwrapper_src_compile() {
	...
	case ${CHOST} in
		...
		*-solaris*)
		...
		;;
		*-linux-gnu|*-freebsd*|*-netbsd*|*-openbsd*)
			defines='-DNEEDS_LIBRARY_INCLUDES -DLIBINC=\"-L\"'
