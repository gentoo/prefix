...
inherit eutils flag-o-matic multilib-minimal libtool
...
LICENSE="FLEX"
SLOT="0"
KEYWORDS="~ppc-aix ~amd64-linux ~arm-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~m68k-mint ~sparc-solaris ~sparc64-solaris ~x64-solaris ~x86-solaris"
