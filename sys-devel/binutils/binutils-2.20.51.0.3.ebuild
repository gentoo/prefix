...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/binutils/binutils-2.20.51.0.3.ebuild,v 1.1 2009/11/21 05:09:07 vapier Exp $
...
# doesn't apply	epatch "${FILESDIR}"/${PN}-2.20.51.0.2-mint.patch
