...
src_compile() {
	...
	if [[ $(get_libdir) != "lib" ]] ; then
		myconf "-Dlibpth=${EPREFIX}/usr/local/$(get_libdir) ${EPREFIX}/$(get_libdir) ${EPREFIX}/usr/$(get_libdir)"
	fi
...
src_install() {
	...
	then
		...
		make DESTDIR="${EDEST}" \
			...
			INSTALLMAN3DIR="${EDEST}/usr/share/man/man3" \
...
EOF
		...
		./perl installman \
			--man1dir="${EDEST}/usr/share/man/man1" --man1ext='1' \
			--man3dir="${EDEST}/usr/share/man/man3" --man3ext='3'
