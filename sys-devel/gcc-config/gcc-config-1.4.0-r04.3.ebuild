...
# $Header: /var/cvsroot/gentoo-x86/sys-devel/gcc-config/gcc-config-1.4.0-r4.ebuild,v 1.11 2008/03/20 20:15:08 vapier Exp $
...
src_unpack() {
	...
	cp "${FILESDIR}"/${PN}-${PV}.noaix  "${S}/"${PN}-${PV} || die
