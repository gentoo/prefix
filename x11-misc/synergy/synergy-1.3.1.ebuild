...
# $Header: /var/cvsroot/gentoo-x86/x11-misc/synergy/synergy-1.3.1.ebuild,v 1.10 2007/12/26 08:21:19 drac Exp $
...
LICENSE="GPL-2"
KEYWORDS="~x86-fbsd ~amd64-linux ~x86-linux ~sparc-solaris ~x86-solaris"
SLOT="0"
IUSE=""
...
src_compile() {
	econf --sysconfdir="${EPREFIX}"/etc || die
	emake || die
}
